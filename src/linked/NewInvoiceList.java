...
public class NewInvoiceList<Invoice> implements Iterable<Invoice> {
	...
	public NewInvoiceList(Comparator<Invoice> comp) {
		this.start = null;
		this.size = 0;
		this.comp = comp;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NewInvoiceList other = (NewInvoiceList) obj;
		if (comp == null) {
			if (other.comp != null)
				return false;
	...
	class IteratorInvoice implements Iterator<Invoice> {
		...
		public IteratorInvoice(){
			this.current = NewInvoiceList.this.start;
		}
		@Override
